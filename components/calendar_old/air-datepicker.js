          ...
          buildHtml() {
              ...
              this.$el.innerHTML =
                  `<div class="air-datepicker-time--current">   
                    <span class="air-datepicker-time--current-hours">${d(i)}</span>   
                    <span class="air-datepicker-time--current-colon">:</span>   
                    <span class="air-datepicker-time--current-minutes">${d(s)}</span>` +
                  (e ? `<span class='air-datepicker-time--current-ampm'>${h}</span>` : "") +
                  '</div><div class="air-datepicker-time--sliders">   <div class="air-datepicker-time--row">' +
                  `      <input type="number" name="hours" value="${t}" min="${a}" max="${r}" step="${l}"/>   </div>   <div class="air-datepicker-time--row">` +
                  `      <input type="number" name="minutes" value="${s}" min="${n}" max="${o}" step="${c}"/>   </div>
                  <div class="time-switch"><input type="checkbox" /><span class="time-switch-icon"></span></div>
                  </div>`;
          }
          defineDOM() {
              let e = (e) => a(e, this.$el);
              (this.$ranges = this.$el.querySelectorAll('[type="number"]')),
